...
<html>
  ...
  <body>
  <h1>User price drop:</h1>


	<form action="<c:url value='/readPriceDropsUser'/>" method="post">
	<input type="hidden" name="method" value="regist"/>
		<div class="form-group">
			<label for="user-id">User Id</label>
			<input id="user-id" class="form-control" required type="text" name="id" value="${form.id }"/>
